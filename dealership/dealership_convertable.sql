...
--
-- Table structure for table `convertable`
--

DROP TABLE IF EXISTS `convertable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `convertable` (
  `idconvertable` int NOT NULL,
  ...
  PRIMARY KEY (`idconvertable`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `convertable`
--

LOCK TABLES `convertable` WRITE;
/*!40000 ALTER TABLE `convertable` DISABLE KEYS */;
/*!40000 ALTER TABLE `convertable` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-17 12:34:43
