...
--
-- Table structure for table `crossover`
--
...
CREATE TABLE `crossover` (
  ...
  PRIMARY KEY (`idcrossover`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `crossover`
--

LOCK TABLES `crossover` WRITE;
/*!40000 ALTER TABLE `crossover` DISABLE KEYS */;
/*!40000 ALTER TABLE `crossover` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-17 12:34:45
